...
class Model(nn.Module):
    ...
    def __init__(self, configs, chunk_size=None):
        """
        ...
        if self.task_name == 'incomplete_classification' or self.task_name == 'incomplete_anomaly_detection':
            self.pred_len = configs.seq_len
        else:
            self.pred_len = configs.pred_len

        # if configs.task_name == 'incomplete_long_term_forecast':
        ...
        print(self.seq_len, self.chunk_size)
        ...
        if self.task_name == 'incomplete_classification':
            self.act = F.gelu
